          ...
          this code looks after displaying the correct error message to the user -->
            ...
            <form method="POST" action="{{ route('admin.publishers.update', $publisher->id)}}">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="pub_name" name="pub_name" value="{{ old('pub_name', $publisher->pub_name) }}" />
              </div>
              <div class="form-group">
                <label for="manager_name">Manager Name</label>
                <input type="text" class="form-control" id="manager_name" name="manager_name" value="{{ old('manager_name', $publisher->manager_name) }}" />
              </div>
               <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="city" name="city" value="{{ old('city', $publisher->city) }}" />
              </div>
              <div class="form-group">
                <label for="state">State</label>
                <input type="text" class="form-control" id="state" name="state" value="{{ old('state', $publisher->state) }}" />
              </div>
              <div class="form-group">
